...
public class Machines {
    ...
    public static MultiMachine HEAT_EXCHANGER = new MultiMachine(GTIRef.ID, "heat_exchanger").setTiers(EV).setMap(RecipeMaps.HEAT_EXCHANGER).addFlags(GUI, FLUID, ITEM, EU).setTile(BlockEntityHeatExchanger::new).custom().setTextureBlock(GregTechBlocks.CASING_TITANIUM);
