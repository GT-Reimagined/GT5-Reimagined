...
public class GT5RLocalizations {
    ...
    public static class en_US extends GTLanguageProvider {
        ...
        protected void addTranslations() {
            ...
            add("tooltip.gt5r.data_orb.elemental_scan", "Elemental Scan");
            ...
            add("gui.recipeviewer.category.gt5r.ore_byproducts_tree", "Ore Byproducts Tree");
            ...
            add("recipe_info.gt5r.hut", "HU/t: %s");
            add("recipe_info.gt5r.total_hu", "Total HU: %s");
            add("recipe_info.gt5r.large_heat_exchanger_only", "Large Heat Exchanger Only");
            add("recipe_info.gt5r.small_heat_exchanger_only", "Small Heat Exchanger Only");
            add("recipe_info.gt5r.start_eu", "Start: %s EU");
...
//            GTAPI.all(ItemPowerUnit.class, domain).stream().filter(i -> i.getId().startsWith("power_unit") || i.getId().startsWith("small_power_unit")).forEach(i -> override(i.getDescriptionId(), lowerUnderscoreToUpperSpaced(i.getId())));
            ...
            override(INVENTORY_TANK_EXTENDER, NONE, "Inventory and Tank Extender");
