...
//        addProcess(comb, Iron);
        ...
        ASSEMBLER.RB().ii(GTCoreItems.SELECTOR_TAG_INGREDIENTS.get(8).get(), INGOT.getMaterialIngredient(Bronze, 8)).io(new ItemStack(getFRItem("sturdy_machine"))).add("sturdy_casing", 64, 32);
        ASSEMBLER.RB().ii(RecipeIngredient.of(getFRItem("sturdy_machine")), GEM.getMaterialIngredient(Diamond, 4)).fi(Water.getLiquid(5000)).io(new ItemStack(getFRItem("hardened_machine"))).add("hardened_casing", 64, 32);
        ASSEMBLER.RB().ii(GTCoreItems.SELECTOR_TAG_INGREDIENTS.get(8).get(), RecipeIngredient.of(ItemTags.LOGS, 8)).fi(FluidIngredient.of(SeedOil.getFluidTag(), 250)).io(new ItemStack(getFRItem("impregnated_casing"))).add("impregnated_casing", 64, 32);
