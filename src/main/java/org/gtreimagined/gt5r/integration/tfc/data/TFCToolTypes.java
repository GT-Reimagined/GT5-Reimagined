...
public class TFCToolTypes {
    ...
    public static final GTToolType JAVELIN = GTAPI.register(GTToolType.class, new GTToolType(GT5Reimagined.ID, "javelin", 2, 1, 10, 3.0f, -2.2f, false)).addEffectiveBlocks(Blocks.COBWEB).setUseAction(UseAnim.SPEAR).setToolSupplier(MaterialJavelin::new);
