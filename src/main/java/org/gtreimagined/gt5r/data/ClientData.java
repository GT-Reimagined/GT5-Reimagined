...
public class ClientData {
    ...
    public static final MenuScreens.ScreenConstructor SCREEN_COAL = GTAPI.register(MenuScreens.ScreenConstructor.class, "coal", GT5Reimagined.ID, (MenuScreens.ScreenConstructor)(a, b, c) -> new ScreenCoalBoiler((ContainerMachine) a,b,c));
