...
public class PyrolysisOvenLoader {
    public static void init(){
        ...
        PYROLYSE_OVEN.RB().ii(RecipeIngredient.of(GTCoreItems.Biochaff, 1), SELECTOR_TAG_INGREDIENTS.get(1)).fi(Water.getLiquid(1000)).fo(Materials.Biomass.getLiquid(1500)).add("biomass", 100, 10);
        PYROLYSE_OVEN.RB().ii(RecipeIngredient.of(GTCoreItems.Biochaff, 1), SELECTOR_TAG_INGREDIENTS.get(2)).fi(Water.getLiquid(1500)).fo(Materials.Biomass.getLiquid(1500)).add("fermented_biomass", 200, 10);
