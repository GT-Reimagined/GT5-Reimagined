...
public class LootLoader {
    public static void init(){
        ...
        //GTLoot.addItem(BuiltInLootTables.SIMPLE_DUNGEON, GTItems.BOTTLE_PURPLE_DRINK.asStack(), 8, 16, 2);
        //GTLoot.addItem(BuiltInLootTables.SIMPLE_DUNGEON, GTItems.BOTTLE_HOLY_WATER.asStack(), 4, 8, 20);
        //GTLoot.addItem(BuiltInLootTables.SIMPLE_DUNGEON, GTItems.BOTTLE_PURPLE_DRINK.asStack(), 8, 16, 80);
        GTLoot.addItem(BuiltInLootTables.SIMPLE_DUNGEON, INGOT.get(Silver, 1), 1, 6, 120);
        GTLoot.addItem(BuiltInLootTables.SIMPLE_DUNGEON, INGOT.get(Lead, 1), 1, 6, 30);
        ...
        GTLoot.addItem(BuiltInLootTables.SIMPLE_DUNGEON, INGOT.get(Manganese, 1), 1, 6, 60);
        GTLoot.addItem(BuiltInLootTables.SIMPLE_DUNGEON, INGOT.get(DamascusSteel, 1), 1, 6, 10);
        ...
        GTLoot.addItem(BuiltInLootTables.SIMPLE_DUNGEON, DUST.get(Neodymium, 1), 1, 6, 40);
        ...
        GTLoot.addItem(BuiltInLootTables.DESERT_PYRAMID, GEM.get(Ruby, 1),
                2, 8, 2);
        ...
        //GTLoot.addItem(BuiltInLootTables.JUNGLE_TEMPLE, GTItems.COIN_GOLD_ANCIENT.asStack(), 16, 64, 10);
        //GTLoot.addItem(BuiltInLootTables.JUNGLE_TEMPLE, GTItems.ZERO_POINT_MODULE.get().getChargedStack(Long.MAX_VALUE), 1, 1, 1);
        ...
        GTLoot.addItem(BuiltInLootTables.ABANDONED_MINESHAFT, PICKAXE_HEAD.get(DamascusSteel, 1), 1, 4, 1);
        GTLoot.addItem(BuiltInLootTables.ABANDONED_MINESHAFT, SHOVEL_HEAD.get(DamascusSteel, 1), 1, 4, 1);

        GTLoot.addItem(BuiltInLootTables.VILLAGE_WEAPONSMITH, DUST.get(Chromium, 1), 1, 4, 6);
        GTLoot.addItem(BuiltInLootTables.VILLAGE_WEAPONSMITH, DUST.get(Neodymium, 1), 2, 8, 6);
        GTLoot.addItem(BuiltInLootTables.VILLAGE_WEAPONSMITH, INGOT.get(Manganese, 1), 2, 8, 12);
        ...
        GTLoot.addItem(BuiltInLootTables.VILLAGE_WEAPONSMITH, INGOT.get(DamascusSteel, 1), 4, 12, 1);

        GTLoot.addItem(BuiltInLootTables.STRONGHOLD_CROSSING, INGOT.get(DamascusSteel, 1), 4, 8, 6);
        GTLoot.addItem(BuiltInLootTables.STRONGHOLD_CROSSING, INGOT.get(Steel, 1), 8, 16, 12);
        GTLoot.addItem(BuiltInLootTables.STRONGHOLD_CROSSING, INGOT.get(Bronze, 1), 8, 16, 12);
        GTLoot.addItem(BuiltInLootTables.STRONGHOLD_CROSSING, INGOT.get(Manganese, 1), 4, 8, 12);
        GTLoot.addItem(BuiltInLootTables.STRONGHOLD_CROSSING, DUST.get(Neodymium, 1), 4, 8, 6);
        GTLoot.addItem(BuiltInLootTables.STRONGHOLD_CROSSING, DUST.get(Chromium, 1), 2, 4, 6);

        GTLoot.addItem(BuiltInLootTables.STRONGHOLD_CORRIDOR, SWORD_BLADE.get(DamascusSteel, 1), 1, 4, 6);
        GTLoot.addItem(BuiltInLootTables.STRONGHOLD_CORRIDOR, AXE_HEAD.get(DamascusSteel, 1), 1, 4, 6);
    }
}
