...
public class MachineRecipes {
        ...
        Arrays.stream(Tier.getAllElectric()).forEach(tier -> {
            ...
            add(CRYSTALLIZATION_CHAMBER, tier, (m,item) -> provider.addItemRecipe(output, "machines", item,
                    ImmutableMap.<Character, Object>builder()
                            ...
                            .put('W', WIRE_GETTER.apply(PipeSize.SMALL, tier)).build(), "CgC", "PHP", "WWW"));
    ...
    private static void addUtilityBlockRecipes(Consumer<FinishedRecipe> output, GTRecipeProvider provider){
        ...
        provider.addItemRecipe(output, "extenders", INVENTORY_BRIDGE.getItem(NONE),
                of('P', GT5RBlocks.ITEM_PIPE_ELECTRUM.getBlockItem(PipeSize.NORMAL),
                        'C', GT5RBlocks.SOLID_STEEL_CASING,
                        'W', WRENCH.getTag(), 'H', HAMMER.getTag()), "HP ", " C ", " PW");
        provider.addItemRecipe(output, "extenders", TANK_BRIDGE.getItem(NONE),
                of('P', GT5RBlocks.FLUID_PIPE_STEEL.getBlockItem(PipeSize.NORMAL),
                        'C', GT5RBlocks.SOLID_STEEL_CASING,
                        'W', WRENCH.getTag(), 'H', HAMMER.getTag()), "H  ", "PCP", "  W");
        provider.addItemRecipe(output, "extenders", INVENTORY_TANK_BRIDGE.getItem(NONE),
                of('P', GT5RBlocks.ITEM_PIPE_ELECTRUM.getBlockItem(PipeSize.NORMAL),
        ...
        provider.addItemRecipe(output, "extenders", INVENTORY_EXTENDER.getItem(NONE),
                of('P', GT5RBlocks.ITEM_PIPE_ELECTRUM.getBlockItem(PipeSize.NORMAL),
                        'C', GT5RBlocks.SOLID_STEEL_CASING,
                        'W', WRENCH.getTag(), 'H', HAMMER.getTag()), " HP", " C ", "PW ");
        provider.addItemRecipe(output, "extenders", TANK_EXTENDER.getItem(NONE),
                of('P', GT5RBlocks.FLUID_PIPE_STEEL.getBlockItem(PipeSize.NORMAL),
                        'C', GT5RBlocks.SOLID_STEEL_CASING,
                        'W', WRENCH.getTag(), 'H', HAMMER.getTag()), "PH ", " C ", " WP");
        provider.addItemRecipe(output, "extenders", INVENTORY_TANK_EXTENDER.getItem(NONE),
                of('P', GT5RBlocks.ITEM_PIPE_ELECTRUM.getBlockItem(PipeSize.NORMAL),
                        'F', GT5RBlocks.FLUID_PIPE_STEEL.getBlockItem(PipeSize.NORMAL),
                        'C', GT5RBlocks.SOLID_STEEL_CASING,
    ...
    private static void addMultiblockRecipes(Consumer<FinishedRecipe> output, GTRecipeProvider provider){
        ...
        add(AUTOCRAFTER_ASSEMBLY_LINE, HV, (m, item) -> provider.addItemRecipe(output, "machines", item,
                ImmutableMap.<Character, Object>builder()
                        ...
                        .put('R', GT5RCovers.COVER_ROBOT_ARM.getItem(HV))
                        .put('C', TIER_CIRCUITS.apply(HV))
                        .put('H', HULL.getItem(HV)).build(), "ARA", "CHC", "ARA"));
