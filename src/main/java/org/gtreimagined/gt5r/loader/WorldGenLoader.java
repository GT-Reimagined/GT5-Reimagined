...
public class WorldGenLoader {
    ...
    private static void initStoneVeins(GTWorldGenEvent ev) {
        ...
        ev.stoneLayer(new StoneLayerBuilder(id("black_granite")).withStone(BLACK_GRANITE).withWeight(3).maxY(0, SHALE.getState().getBlock()).inDimensions(overworld).buildVein());
        ev.stoneLayer(new StoneLayerBuilder(id("red_granite")).withStone(RED_GRANITE).withWeight(3).maxY(0, GRANITE.getState().getBlock()).inDimensions(overworld).buildVein());
        ev.stoneLayer(new StoneLayerBuilder(id("komatiite")).withStone(KOMATIITE).withWeight(3).inDimensions(overworld).buildVein());
        ev.stoneLayer(new StoneLayerBuilder(id("basalt")).withStone(BASALT).withWeight(3).inDimensions(overworld).buildVein());
        ev.stoneLayer(new StoneLayerBuilder(id("marble")).withStone(MARBLE).withWeight(3).inDimensions(overworld).buildVein());
        ev.stoneLayer(new StoneLayerBuilder(id("limestone")).withStone(LIMESTONE).withWeight(3).inDimensions(overworld).buildVein());
        ev.stoneLayer(new StoneLayerBuilder(id("green_schist")).withStone(GREEN_SCHIST).withWeight(3).inDimensions(overworld).buildVein());
        ev.stoneLayer(new StoneLayerBuilder(id("blue_schist")).withStone(BLUE_SCHIST).withWeight(3).inDimensions(overworld).buildVein());
        ev.stoneLayer(new StoneLayerBuilder(id("kimberlite")).withStone(KIMBERLITE).withWeight(3).inDimensions(overworld).buildVein());
        ev.stoneLayer(new StoneLayerBuilder(id("quartzite")).withStone(QUARTZITE).withWeight(3).inDimensions(overworld).buildVein());
        ev.stoneLayer(new StoneLayerBuilder(id("shale")).withStone(SHALE).withWeight(3).minY(0, BLACK_GRANITE.getState().getBlock()).inDimensions(overworld).buildVein());
        ev.stoneLayer(new StoneLayerBuilder(id("slate")).withStone(SLATE).withWeight(3).minY(0, DEEPSLATE.getState().getBlock()).inDimensions(overworld).buildVein());
        ev.stoneLayer(new StoneLayerBuilder(id("deepslate")).withStone(DEEPSLATE).withWeight(3).maxY(0, SLATE.getState().getBlock()).inDimensions(overworld).buildVein());
        ev.stoneLayer(new StoneLayerBuilder(id("granite")).withStone(GRANITE).withWeight(3).minY(0, RED_GRANITE.getState().getBlock()).inDimensions(overworld).buildVein());
        ev.stoneLayer(new StoneLayerBuilder(id("diorite")).withStone(DIORITE).withWeight(3).inDimensions(overworld).buildVein());
        ev.stoneLayer(new StoneLayerBuilder(id("andesite")).withStone(ANDESITE).withWeight(3).inDimensions(overworld).buildVein());
