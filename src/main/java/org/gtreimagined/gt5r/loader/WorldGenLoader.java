...
public class WorldGenLoader {
    ...
    private static void initSmallOres(GTWorldGenEvent event){
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "copper")).withMaterial(Copper).withAmountPerChunk(32).atHeight(16, 126).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "tin")).withMaterial(Tin).withAmountPerChunk(32).atHeight(16, 126).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "bismuth")).withMaterial(Bismuth).withAmountPerChunk(8).atHeight(76, 196).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "coal")).withMaterial(Coal).withAmountPerChunk(24).atHeight(16, 126).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "iron")).withMaterial(Iron).withAmountPerChunk(16).atHeight(16, 61).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "lead")).withMaterial(Lead).withAmountPerChunk(16).atHeight(16, 61).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "zinc")).withMaterial(Zinc).withAmountPerChunk(12).atHeight(16, 96).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "gold")).withMaterial(Gold).withAmountPerChunk(8).atHeight(-34, 16).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "silver")).withMaterial(Silver).withAmountPerChunk(8).atHeight(-34, 16).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "nickel")).withMaterial(Nickel).withAmountPerChunk(8).atHeight(-34, 16).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "lapis")).withMaterial(Lapis).withAmountPerChunk(4).atHeight(-34, 16).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "diamond")).withMaterial(Diamond).withAmountPerChunk(3).atHeight(-59, -52).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "emerald")).withMaterial(Emerald).withAmountPerChunk(2).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "ruby")).withMaterial(Ruby).withAmountPerChunk(2).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "sapphire")).withMaterial(Sapphire).withAmountPerChunk(2).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "green_sapphire")).withMaterial(GreenSapphire).withAmountPerChunk(2).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "olivine")).withMaterial(Olivine).withAmountPerChunk(2).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "topaz")).withMaterial(Topaz).withAmountPerChunk(2).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "tanzanite")).withMaterial(Tanzanite).withAmountPerChunk(2).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "amethyst")).withMaterial(Amethyst).withAmountPerChunk(2).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "opal")).withMaterial(Opal).withAmountPerChunk(2).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "jade")).withMaterial(Jade).withAmountPerChunk(2).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "blue_topaz")).withMaterial(BlueTopaz).withAmountPerChunk(2).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "amber")).withMaterial(Amber).withAmountPerChunk(2).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        //event.smallOre(new SmallOreBuilder().withMaterial(FoolsRuby).withAmountPerChunk(1).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "red_garnet")).withMaterial(RedGarnet).withAmountPerChunk(2).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "yellow_garnet")).withMaterial(YellowGarnet).withAmountPerChunk(2).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "redstone")).withMaterial(Redstone).withAmountPerChunk(8).atHeight(-59, -34).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "chromite")).withMaterial(Chromite).withAmountPerChunk(8).atHeight(20, 50).inDimensions(END).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "platinum")).withMaterial(Platinum).withAmountPerChunk(8).atHeight(20, 40).inDimensions(END).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "iridium")).withMaterial(Iridium).withAmountPerChunk(8).atHeight(20, 40).inDimensions(END).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "quartz")).withMaterial(Quartz).withAmountPerChunk(64).atHeight(30, 120).inDimensions(NETHER).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "saltpeter")).withMaterial(Saltpeter).withAmountPerChunk(8).atHeight(10, 60).inDimensions(NETHER).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "sulfur")).withMaterial(Sulfur).withAmountPerChunk(32).atHeight(5, 60).inDimensions(NETHER).buildMaterial());
        event.smallOre(new SmallOreBuilder(new ResourceLocation(GT5RRef.ID, "sulfur_overworld")).withMaterial(Sulfur).withAmountPerChunk(8).atHeight(-59, -34).inDimensions(OVERWORLD, JAMD_MINING).buildMaterial());
    }
