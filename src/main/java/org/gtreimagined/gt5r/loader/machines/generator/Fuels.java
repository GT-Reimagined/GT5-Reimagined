...
public class Fuels {
    public static void init() {
        ...
        MAGIC_FUELS.RB().ii(CHIPPED_GEM.getMaterialIngredient(Amber, 1)).add("chipped_amber", 1, 1000);
        MAGIC_FUELS.RB().ii(PLATE.getMaterialIngredient(Amber, 1)).add("amber_plate", 1, 3000);
        MAGIC_FUELS.RB().ii(FLAWED_GEM.getMaterialIngredient(Amber, 1)).add("flawed_amber", 1, 3000);
        ...
        MAGIC_FUELS.RB().ii(FLAWLESS_GEM.getMaterialIngredient(Amber, 1)).add("flawless_amber", 1, 12000);
        MAGIC_FUELS.RB().ii(EXQUISITE_GEM.getMaterialIngredient(Amber, 1)).add("exquisite_amber", 1, 24000);
