...
public class MixerLoader {
    ...
    private static void recipes() {
        ...
        MIXER.RB().ii(of(SMALL_DUST.get(Salt,1))).fi(Water.getLiquid(750)).fo(SaltWater.getLiquid(1000)).add("salt_water",2*20, 8);
        MIXER.RB().ii(of(SMALL_DUST.get(Salt,1))).fi(DistilledWater.getLiquid(750)).fo(SaltWater.getLiquid(1000)).add("salt_water_2",2*20, 8);
