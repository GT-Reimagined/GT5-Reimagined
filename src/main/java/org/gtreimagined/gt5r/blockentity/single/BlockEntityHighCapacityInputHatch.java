...
public class BlockEntityHighCapacityInputHatch extends BlockEntityHatch<BlockEntityHighCapacityInputHatch> {
    public BlockEntityHighCapacityInputHatch(HatchMachine type, BlockPos pos, BlockState state) {
